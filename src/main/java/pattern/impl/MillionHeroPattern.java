...
public class MillionHeroPattern implements Pattern {
    ...
    public void run() throws UnsupportedEncodingException {
        ...
        com.alibaba.fastjson.JSONObject jsonInfo = JSON.parseObject(questionAndAnswers);
        String question = information.getQuestion();
        String[] answers = information.getAns();

        JSONArray wordsResult = jsonInfo.getJSONArray("words_result");
        question = wordsResult.getString(0);
        if (question == null) {
